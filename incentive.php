	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Employee Incentive</div>
			</div> <!-- /panel-heading -->
...
$empId = $_POST['empID'];
$query = "select * from orders where emp_id = '$empId'";
...
<td> <?php echo $rec['emp_incentive']; ?> </td> 
</tr>
<?php } ?>
<tr>
...
<?php
$result = mysql_query("SELECT SUM(emp_incentive) AS emp_incentive FROM orders where emp_id='$empId'"); 
$row = mysql_fetch_assoc($result); 
$salary = $row['emp_incentive'];
echo "<b>".$salary."</b>";
?>
</td>
</tr>
